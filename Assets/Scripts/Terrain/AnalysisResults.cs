...
namespace Traversify.AI {
    ...
    public class AnalysisResults {
        ...
        /// <summary>
        /// Raw source image used for analysis (map texture).
        /// </summary>
        ...
        /// <summary>
        /// Detected terrain objects for object-based influences.
        /// </summary>
        public List<DetectedObject> terrainObjects = new List<DetectedObject>();
        
        /// <summary>
        /// Detected non-terrain objects (buildings, vehicles, etc.).
        /// </summary>
        public List<DetectedObject> nonTerrainObjects = new List<DetectedObject>();
        
        /// <summary>
        /// Enhanced descriptions generated by AI models.
        /// </summary>
        public Dictionary<string, string> enhancedDescriptions = new Dictionary<string, string>();
        
        /// <summary>
        /// Size of the terrain in world units.
        /// </summary>
        public Vector2 terrainSize = Vector2.zero;
        
        /// <summary>
        /// Maximum height value in the terrain.
        /// </summary>
        ...
        /// </summary>
        public DateTime analysisTimestamp = DateTime.Now;
